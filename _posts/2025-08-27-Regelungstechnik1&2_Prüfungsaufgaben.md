...
### 9. 传输环节如何分类？描述其特性并绘制相关图表，以及如何从图中读取关键参数。
...
### 16. 给出稳定控制回路中的控制器参数变化，以消除振荡。用根轨迹、开环伯德图和开环奈奎斯特图来解释你的方法。
...
### 11. 为什么状态反馈在控制理论中具有如此重要的意义，尽管它通常在技术上是无法实现的？如何设计和实现状态反馈？在从状态反馈切换到输出反馈时会产生什么问题？在什么条件下，具有状态反馈的控制回路具有设定值跟随的特性？
...
### 13. 什么是用于单一和多重回路控制的控制设计原则？这些原则何时适用？如何制定设计要求？会产生什么样的控制法律？
...
### 14. 比较不同的控制设计方法在设计和实现方面的复杂性。哪些方法在要求较低时是实用的，哪些在有严格要求时是必要的？
...
### 15. 在什么情况下，一个多变量控制器的设计可以简化为多个单变量控制器的设计？什么是分散式控制？如何设计分散式控制系统？
...
### 12. 比较连续和离散控制系统的优缺点。采样对控制设计和实现带来了哪些简化和挑战？如何选择采样时间？在什么情况下，连续控制系统可以无问题地作为离散控制系统使用？
